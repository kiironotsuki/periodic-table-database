...
--
-- Name: properties fk_element; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_element FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
